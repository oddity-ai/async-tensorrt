...
/// [`async_cuda::DeviceBuffer`] that refers to it.
...
/// Convenience macro for testing to take a [`async_cuda::DeviceBuffer`] and copy it back to the
/// host, then return a [`Vec`] of that memory.
macro_rules! to_host {
